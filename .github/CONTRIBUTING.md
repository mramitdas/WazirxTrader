...
Please review our [Code of Conduct](https://github.com/mramitdas/WazirxTrader/blob/prodCODE_OF_CONDUCT.md). It is in effect at all times. We expect it to be honored by everyone who contributes to this project. Acting like an asshole will not be tolerated.

## :bulb: Asking Questions

See our [Support Guide](https://github.com/mramitdas/WazirxTrader/blob/prodSUPPORT.md). In short, GitHub issues are not the appropriate place to debug your specific project, but should be reserved for filing bugs and feature requests.
...
Review our [Security Policy](https://github.com/mramitdas/WazirxTrader/blob/prodSECURITY.md). **Do not** file a public issue for security vulnerabilities.
...
- **Review the documentation and [Support Guide](https://github.com/mramitdas/WazirxTrader/blob/prodSUPPORT.md)** before opening a new issue.
